...
import com.project.android.bekantan.adapter.RecentChatRecyclerAdapter;
...
public class ChatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.chat_item);
        setupRecyclerView();
        return view;
    }
    void setupRecyclerView() {
        ...
        Query query = FirebaseUtil.allChatroomCollectionReference()
                .whereArrayContains("userIds",FirebaseUtil.cuurentUserId())
